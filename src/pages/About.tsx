    ...
    <div className="py-24 space-y-32">
      ...
      <section className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="space-y-12">
          <div className="space-y-4">
            <p className="text-pharoic-gold text-sm font-bold tracking-[0.4em] uppercase">{getContent('origin_label', 'The Genesis')}</p>
            <h1 className="text-6xl font-serif font-bold text-white tracking-tight leading-tight">{getContent('origin_title', 'BORN FROM')} <br /> {getContent('origin_subtitle', 'THE NILE')}</h1>
          </div>
          <p className="text-white/60 text-lg leading-relaxed max-w-xl">
            {getContent('origin_description', 'Osirids was founded on a simple yet profound realization: the stories of our ancestors are too powerful to be left in the past. We set out to create more than just a clothing brand—we created a bridge between the ancient wisdom of Egypt and the modern landscape of high-fashion.')}
          </p>
        ...
        <div className="relative group">
          ...
          <img
            src={getImage('origin_image', "https://images.unsplash.com/photo-1539106397933-7bb303553229?q=80&w=1000&auto=format&fit=crop")}
            alt="Craftsmanship"
      ...
      <section className="bg-white/[0.02] py-32 border-y border-white/5">
        <div className="container mx-auto px-4 text-center max-w-3xl space-y-12">
          <h2 className="text-4xl font-serif font-bold text-white uppercase tracking-widest italic">{getContent('philosophy_title', 'The Osiris Philosophy')}</h2>
          <p className="text-xl text-white/70 font-light leading-relaxed italic">
            {getContent('philosophy_quote', '"Like Osiris, we believe in the cycle of rebirth. We take the timeless symbols of our heritage and breathe new life into them through contemporary design and sustainable materials."')}
          </p>
